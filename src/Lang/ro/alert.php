...
return [
    'success' => [
        'title'  => 'Well done!',
        'reason' => [
            'submitted_to_post'       => 'Răspunsul a fost trimis cu succes la '.mb_strtolower(trans('forum::intro.titles.discussion')).'.',
            'updated_post'            => 'Actualizarea lui '.mb_strtolower(trans('forum::intro.titles.discussion')).' a fost făcută cu success.',
            'destroy_post'            => 'S-a șters cu succes răspunsul și '.mb_strtolower(trans('forum::intro.titles.discussion')).'.',
            'destroy_from_discussion' => 'A fost șters cu succes răspunsul de la '.mb_strtolower(trans('forum::intro.titles.discussion')).'.',
            'created_discussion'      => 'A fost creat cu succes un nou '.mb_strtolower(trans('forum::intro.titles.discussion')).'.',
        ],
    ],
    'info' => [
        'title' => 'Atenție!',
    ...
    'danger'  => [
        ...
        'reason' => [
            ...
            'create_discussion' => 'Hopa :( Se pare că este o problema în crearea '.mb_strtolower(trans('forum::intro.titles.discussion')).'.',
