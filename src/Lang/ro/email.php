...
return [
    ...
    'view_discussion' => 'Vizualizați '.mb_strtolower(trans('forum::intro.titles.discussion')).'.',
    ...
    'unsuscribe'      => [
        ...
        'link'    => 'Dezabonează-te de la '.mb_strtolower(trans('forum::intro.titles.discussion')).'.',
    ],
];
