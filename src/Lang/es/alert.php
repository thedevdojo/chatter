...
return [
    'success' => [
        'title'  => '¡Bien hecho!',
        'reason' => [
            'submitted_to_post'       => 'Respuesta enviada correctamente a la '.mb_strtolower(trans('forum::intro.titles.discussion')),
            'updated_post'            =>  trans('forum::intro.titles.discussion').' actualizada correctamente.',
            'destroy_post'            => 'Se ha borrado correctamente la respuesta y la '.mb_strtolower(trans('forum::intro.titles.discussion')),
            'destroy_from_discussion' => 'Se ha borrado correctamente la respuesta de la '.mb_strtolower(trans('forum::intro.titles.discussion')),
            'created_discussion'      => 'Se ha creado correctamente una nueva '.mb_strtolower(trans('forum::intro.titles.discussion')),
        ],
    ],
    'info' => [
        'title' => '¡Aviso!',
    ...
    'danger'  => [
        ...
        'reason' => [
            ...
            'create_discussion' => '¡Ups! Parece que hay un problema al crear la '.mb_strtolower(trans('forum::intro.titles.discussion')).'. :(',
