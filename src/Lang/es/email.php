...
return [
    ...
    'greeting'        => 'Hola,',
    'body'            => 'Te informamos que alguien ha respondido a una '.mb_strtolower(trans('forum::intro.titles.discussion')).' publicada en',
    'view_discussion' => 'Ver la '.mb_strtolower(trans('forum::intro.titles.discussion')),
    ...
    'unsuscribe'      => [
        ...
        'link'    => 'Anular la suscripción a la '.mb_strtolower(trans('forum::intro.titles.discussion')),
    ],
];
